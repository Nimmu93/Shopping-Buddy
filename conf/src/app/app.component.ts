...
export class ConferenceApp {
  ...
  appPages: PageInterface[] = [
    { title: 'Items', name: 'TabsPage', component: TabsPage, tabComponent: itemsPage, index: 0, icon: 'cart' },
    { title: 'Contacts', name: 'TabsPage', component: TabsPage, tabComponent: contactsListPage, index: 1, icon: 'contacts' },
    { title: 'Daily Deals', name: 'TabsPage', component: TabsPage, tabComponent: DailydealsPage, index: 2, icon: 'star' },
