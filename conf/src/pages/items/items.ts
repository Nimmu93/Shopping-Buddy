...
export class itemsPage {
  ...
  @ViewChild('itemsList', { read: List }) itemsList: List;
  ...
  updateitems() {
    ...
    this.itemsList && this.itemsList.closeSlidingItems();
  ...
  presentFilter() {
    let modal = this.modalCtrl.create(itemsFilterPage, this.excludeTracks);
    modal.present();
